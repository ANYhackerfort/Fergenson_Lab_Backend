...
public:
  ...
  explicit PROTOBUF_CONSTEXPR
      MessageResponse(::google::protobuf::internal::ConstantInitialized);
...
private:
  ...
  _internal_set_response(const std::string &value);
...
public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR
      MessageRequest(::google::protobuf::internal::ConstantInitialized);
...
private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<0, 1, 0, 30, 2>
      _table_;
...
MessageRequest::message() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string *
MessageRequest::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
